...
class ToolDefinition(Protocol):
    ...
    #: Optional. What the run store may keep. A definition that omits it keeps
    #: its whole request, which is the right answer only when the request holds
    #: nothing the deployment should not retain.
    def durable_request(self, request: object) -> object: ...
